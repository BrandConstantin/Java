package pkg30_programarcliente_ftp;
 ...
 * @author IMCG
 */
public class ProgramarCliente_FTP {
	...
	/**
	 * **************************************************************************
	 * recupera el contenido de un fichero desde un Servidor FTP, y lo deposita
	 * en un nuevo fichero en el directorio de nuestro proyecto
	 *
	 * @param args
	 */
