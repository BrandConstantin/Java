...
public class Ejer15 {
  ...
  System.out.println("Elige hacia donde quieres que apunte el vértice de "
    + "la pirámide");
  ...
  String dibujo = System.console().readLine();
  ...
  switch (caso) {
    ...
    break;
    case 3: 
    System.out.println(dibujo + dibujo + dibujo + dibujo + dibujo + dibujo + dibujo + dibujo +"");
    System.out.println(dibujo + " " + " " + " " + " " + " " + " " + dibujo +" ");
    System.out.println(" " + dibujo + " " + "" + " " + " " + " " + dibujo +" ");
    System.out.println(" " + " " + dibujo + " " + " " + " " + dibujo + " " +" ");
    System.out.println(" " + " " + " " + dibujo + dibujo + dibujo + " " + "" +" ");
