...
public class distanciaCoche{
  public static void main(String[] args) {
      ...
      double tiempo = (distancia / velocidad) * 60; //para averiguar la distancia la formula es distancia=velocidad*tiempo
      
       System.out.printf("Para recorer esa distacia con esta velocidad hace falta un tiempo de %f. minutos", tiempo);
       }
}
